...
<div class="container">
    <div class="row">
        <div class="col-sm-10">
          ...
          <p>
                <br>Contact LifeStyle Store Support<br><br>
        ...
        <div class="col-sm-4">
	       <div class="contact-info">
	           <h2 class="title">Company Information :</h2>
                ...
                F-1/5, Industrial Area, Phase-1,<br>
                New Delhi - 110020,<br>
                Delhi, INDIA <br><br>
             For any query call on 7253904660 between 09:30 to 18:30 IST or
             by email at help@lifestylestore.com<br><br>
	               </address>
